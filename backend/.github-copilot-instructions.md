...
- **Name:** "Toomas633's Dungeon" Backend (v2.0.0)
- **Stack:** Node.js 18+ (24+ recommended) with Express.js 5.1.0 and TypeScript using ESM modules
...
- **Testing:** Vitest with supertest for comprehensive API testing

## Technical Stack & Dependencies

### Core Technologies

- **Runtime:** Node.js 18.0.0+ (Node.js 24+ recommended for latest features)
- **Language:** TypeScript 5.9+ with strict type checking
- **Framework:** Express.js 5.1.0 with TypeScript types and ESM modules
...
- **express** (5.1.0): Web framework with TypeScript type definitions
- **nodemailer** (7.0.10): SMTP email transport with types
- **cors** (2.8.5): Cross-origin resource sharing middleware
- **express-rate-limit** (8.2.1): Rate limiting for API endpoints
- **body-parser** (2.2.0): JSON request parsing
- **dotenv** (17.2.3): Environment variable management

### Development Dependencies

- **typescript** (5.9.3): TypeScript compiler and language support
- **tsx** (4.20.6): Fast TypeScript execution for development
...
│   ├── app.ts                 # Express app configuration, middleware, server startup, and graceful shutdown
│   ├── config/
...
- **Vitest (4.0.13):** Modern testing framework with TypeScript support
...
```
tests/
├── app.spec.ts           # Application and server tests
...
import { serviceFunction } from '../src/services/service.js'
...
- **Test Pattern:** `**/*.{spec,test}.{ts,js}` in tests directory
- **Coverage:** V8 provider with LCOV and HTML reporters
- **TypeScript:** Full TypeScript support with tsx
- **Watch:** Excludes dist and node_modules from watch
- **Globals:** Test globals (describe, it, expect) available without imports
